...
import 'package:okra_distributer/components/sale_item_card.dart';
...
import 'package:okra_distributer/view/sale/sale%20form/add_item_form.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SaleBloc, SaleState>(
        ...
        builder: (context, state) {
          double netAmount = billedItems.fold(
              0, (previousValue, element) => previousValue + element.price);
          double totalDiscount = billedItems.fold(
              0,
              (previousValue, element) =>
                  previousValue + element.disountNumber);
          double TotalQty = billedItems.fold(
                    ...
                    child: billedItems.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              double totalQtyPrice = billedItems[index].Qty *
                                  billedItems[index].price;
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    AppText(
                                                        title:
                                                            "${billedItems[index].discountPercentage} % | ${billedItems[index].price} Rs = - ${billedItems[index].disountNumber} Rs",
                                                        color: Colors.black,
                                                        font_size: 10,
                                                        fontWeight:
                                                            FontWeight.w800),
