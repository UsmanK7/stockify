...
class AddReturnItem extends StatefulWidget {
  const AddReturnItem({super.key});

  @override
  State<AddReturnItem> createState() => _AddReturnItemState();
}

class _AddReturnItemState extends State<AddReturnItem> {
  @override
  void initState() {
    saleReturnBloc.add(SaleInitalEvent());
                          ...
                          return Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton2<String>(
                                ...
                                onChanged: (value) {
                                  ProductName = value!;
                                  saleReturnBloc.add(SaleDropdownSelectEvent(
                                      selectedItem: value!,
                              ...
                              child: Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton2<String>(
                                    ...
                                    onChanged: (value) {
                                      selectedUnit = value!;
                                      saleReturnBloc.add(SaleUnitSelectedEvent(
                                          selectedUnit: value!,
