...
class SaleOrderListDetails extends StatefulWidget {
  final SaleId;
  const SaleOrderListDetails({super.key, required this.SaleId});

  @override
  State<SaleOrderListDetails> createState() => SaleOrderListDetailsState();
}

class SaleOrderListDetailsState extends State<SaleOrderListDetails> {
